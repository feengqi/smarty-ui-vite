(function (global, factory) {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      vue.openBlock(), vue.createElementBlock('button', null, 'SFC Button')
    );
  }
  const SFCButton = /* @__PURE__ */ _export_sfc(_sfc_main, [
    ['render', _sfc_render],
  ]);
  const JSXButton = vue.defineComponent({
    name: 'JSXButton',
    render() {
      return vue.createVNode('button', null, [
        vue.createTextVNode('JSX Button'),
      ]);
    },
  });
  const entry = {
